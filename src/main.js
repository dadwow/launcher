...
// Disable signature verification for Windows and macOS (for unsigned builds)
...
if (process.platform === 'darwin') {
    // Disable signature verification on macOS for unsigned builds
    // This allows auto-updates to work without code signing certificates
    autoUpdater.forceDevUpdateConfig = true;
    process.env.ELECTRON_UPDATER_ALLOW_DOWNGRADE = '1';
}
